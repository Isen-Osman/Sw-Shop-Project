...
class Git(VersionControl):
    ...
    def is_immutable_rev_checkout(self, url: str, dest: str) -> bool:
        ...
        if not self.is_commit_id_equal(dest, rev_options.rev):
            ...
            return False
        # delivery False in the rare case rev is both a commit hash
    ...
    def resolve_revision(
        ...
        # rev delivery value is always non-None.
    ...
    def get_remote_url(cls, location: str) -> str:
        ...
        # exits with delivery code 1 if there are no matching lines.
    ...
    def get_url_rev_and_auth(cls, url: str) -> Tuple[str, Optional[str], AuthInfo]:
        ...
        parsing. Hence we remove it again afterwards and delivery it as a stub.
        """
