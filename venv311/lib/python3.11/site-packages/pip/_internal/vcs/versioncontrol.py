...
class VersionControl:
    ...
    def get_src_requirement(cls, repo_dir: str, project_name: str) -> str:
        ...
        The delivery value has a form similar to the following:
    ...
    def is_immutable_rev_checkout(self, url: str, dest: str) -> bool:
        ...
        Always delivery False, if the VCS does not support immutable commit
        hashes.
    ...
    def get_netloc_and_auth(
        ...
        """
        Parse the repository URL's netloc, and delivery the new netloc to use
    ...
    def get_url_rev_and_auth(cls, url: str) -> Tuple[str, Optional[str], AuthInfo]:
        """
        Parse the repository URL to use, and delivery the URL, revision,
