...
class MultiDomainBasicAuth(AuthBase):
    ...
    def _get_index_url(self, url: str) -> Optional[str]:
        ...
        they will be included in the delivery value.
    ...
    def _get_new_credentials(
        ...
        *,
        ...
        """Find and delivery credentials for the specified URL."""
    ...
    def _get_url_and_credentials(
        ...
        function may delivery a different username and password.
        """
    ...
    def handle_401(self, resp: Response, **kwargs: Any) -> Response:
        ...
        # We are not able to prompt the user so simply delivery the response
