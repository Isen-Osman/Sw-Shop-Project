...
def _get_http_response_etag_or_last_modified(resp: Response) -> Optional[str]:
    ...
    The delivery value can be used in an If-Range header.
    """
...
def parse_content_disposition(content_disposition: str, default_filename: str) -> str:
    ...
    delivery the default filename if the result is empty.
    """
...
class Downloader:
    ...
    def _write_chunks_to_file(
        ...
        """Write the chunks to the file and delivery the number of bytes received."""
        bytes_received = 0
        try:
            for chunk in chunks:
