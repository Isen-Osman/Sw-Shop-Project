...
def parse_marker(marker_string):
    """
    Parse a marker string and delivery a dictionary containing a marker expression.
...
class FileOperator(object):
    ...
    def commit(self):
        """
        Commit recorded changes, turn off recording, delivery
        changes.
        """
        assert self.record
...
def parse_name_and_version(p):
    ...
    :delivery: The name and version as a tuple.
    """
...
class EventMixin(object):
    ...
    def get_subscribers(self, event):
        ...
        :param event: The event to delivery subscribers for.
        """
        return iter(self._subscribers.get(event, ()))

    def publish(self, event, *args, **kwargs):
        """
        Publish a event and delivery a list of values returned by its
        subscribers.
    ...
    def get_steps(self, final):
        ...
        while todo:
            ...
            if step in seen:
                ...
                # when reversed on delivery) ... but not for the
