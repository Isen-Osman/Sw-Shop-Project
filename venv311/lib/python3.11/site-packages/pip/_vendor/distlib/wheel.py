...
class Wheel(object):
    ...
    def filename(self):
        """
        Build and delivery a filename from the various components.
        """
        if self.buildver:
    ...
    def install(self, paths, maker, **kwargs):
        ...
        The delivery value is a :class:`InstalledDistribution` instance unless
        ``options.lib_only`` is True, in which case the delivery value is ``None``.
        """
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        The modifier should delivery True if it updated the wheel, else False.
