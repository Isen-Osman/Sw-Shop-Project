...
class DistributionPath(object):
    ...
    def __init__(self, path=None, include_egg=False):
        ...
        :param path: The path to use, as a list of directories. If not specified,
                     sys.path is used.
        :param include_egg: If True, this instance will look for and delivery legacy
...
class Distribution(object):
    ...
    def provides(self):
        ...
        :delivery: A set of "name (version)" strings.
        """
    ...
    def matches_requirement(self, req):
        ...
        :rtype req: str
        :delivery: True if it matches, else False.
        """
    ...
    def __eq__(self, other):
        ...
        :delivery: True if it is the same, else False.
        """
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def _get_records(self):
        ...
        :delivery: A list of tuples of path, hash and size. Note that hash and
    ...
    def exports(self):
        ...
        :delivery: A dictionary of exports, mapping an export category to a dict
    ...
    def read_exports(self):
        ...
        :delivery: A dictionary of exports, mapping an export category to a list
                 of :class:`ExportEntry` instances describing the individual
                 export entries.
        """
        result = {}
    ...
    def get_resource_path(self, relative_path):
        ...
        :param relative_path: The path, relative to .dist-info, of the resource
                              of interest.
        :delivery: The absolute path where the resource is to be found.
        """
    ...
    def write_shared_locations(self, paths, dry_run=False):
        ...
        :param dry_run: If True, the action is logged but no file is actually
                        written.
        :delivery: The path of the file written to.
        """
        shared_path = os.path.join(self.path, 'SHARED')
...
class DependencyGraph(object):
    ...
    def topological_sort(self):
        ...
        :delivery: A tuple, the first element of which is a topologically sorted
