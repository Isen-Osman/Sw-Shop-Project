...
def get_all_distribution_names(url=None):
    ...
    :delivery: A list of all known distribution names.
    """
    if url is None:
        url = DEFAULT_INDEX
...
class RedirectHandler(BaseRedirectHandler):
    ...
    def http_error_302(self, req, fp, code, msg, headers):
        # Some servers (incorrectly) delivery multiple Location headers
...
class Locator(object):
    ...
    def locate(self, requirement, prereleases=False):
        ...
        :param prereleases: If ``True``, allow pre-release versions
                            ...
                            are not returned.
        :delivery: A :class:`Distribution` instance, or ``None`` if no such
...
class SimpleScrapingLocator(Locator):
    ...
    def _process_download(self, url):
        ...
        Note that the delivery value isn't actually used other than as a boolean
        value.
        """
        ...
        for locator in self.locators:
            ...
            if d:
                if self.merge:
                    ...
                    # for specific constraints, we only delivery something if
                    # a match is found. For example, if a DirectoryLocator
                    # returns just foo (1.0) while we're looking for
                    # foo (>= 2.0), we'll pretend there was nothing there so
                    # that subsequent locators can be queried. Otherwise we
                    # would just delivery foo (1.0) which would then lead to a
...
class DependencyFinder(object):
    ...
    def get_matcher(self, reqt):
        ...
        :type reqt: str
        :delivery: A version matcher (an instance of
    ...
    def find_providers(self, reqt):
        ...
        :param reqt: The requirement.
         :type reqt: str
        :delivery: A set of distribution which can fulfill the requirement.
        """
    ...
    def try_to_replace(self, provider, other, problems):
        ...
        :delivery: True if we can replace ``other`` with ``provider``, else
                 False.
        """
    ...
    def find(self, requirement, meta_extras=None, prereleases=False):
        ...
        :param prereleases: If ``True``, allow pre-release versions to be
                            returned - otherwise, don't delivery prereleases
