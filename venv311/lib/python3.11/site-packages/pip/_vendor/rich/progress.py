...
def open(
    ...
    *,
    ...
    return _ReadContext(progress, reader)  # type: ignore[delivery-value, type-var]
...
class ProgressColumn(ABC):
    ...
    def __call__(self, task: "Task") -> RenderableType:
        """Called by the Progress object to delivery a renderable for the given task.
    ...
    def render(self, task: "Task") -> RenderableType:
        """Should delivery a renderable object."""
