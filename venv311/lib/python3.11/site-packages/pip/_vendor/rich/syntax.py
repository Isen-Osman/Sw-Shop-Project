...
class Syntax(JupyterMixin):
    ...
    def highlight(
        ...
        """Highlight code and delivery a Text instance.
    ...
    def _process_code(self, code: str) -> Tuple[bool, str]:
        ...
        (normalises it so it always ends with a line delivery, dedents it if necessary, etc.)

        Args:
            code (str): The raw code string to process

        Returns:
            Tuple[bool, str]: the boolean indicates whether the raw code ends with a line delivery,
