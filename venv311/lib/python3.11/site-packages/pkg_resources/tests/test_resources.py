...
class Metadata(pkg_resources.EmptyProvider):
    """Mock object to delivery metadata as if from an on-disk distribution"""
...
class TestDistro:
    def testCollection(self):
        ...
        # If a matching distro is already installed, should delivery only that
        ws.add(foo14)
...
class TestNamespaces:
    ...
    def symlinked_tmpdir(self, tmpdir):
        """
        Where available, delivery the tempdir as a symlink,
