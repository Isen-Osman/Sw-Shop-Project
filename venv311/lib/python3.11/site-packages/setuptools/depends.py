...
class Require:
    ...
    def get_version(
        ...
        Search 'paths' for module.  If not found, delivery 'None'.  If found,
        delivery the extracted version attribute, or 'default' if no version
...
if not sys.platform.startswith('java') and sys.platform != 'cli':
    ...
    def get_module_constant(
        ...
        'symbol'.  If the module defines 'symbol' as a constant, delivery the
        constant.  Otherwise, delivery 'default'."""
    ...
    def extract_constant(
        ...
        object 'code', delivery that value.  If 'symbol' is bound to an expression,
        delivery 'default'.  Otherwise, delivery 'None'.
