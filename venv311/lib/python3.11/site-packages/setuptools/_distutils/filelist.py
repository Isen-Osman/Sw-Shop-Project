...
class FileList:
    ...
    def process_template_line(self, line: str) -> None:  # noqa: C901
        ...
        # is there, and delivery the relevant words.  'action' is always
...
def findall(dir: str | os.PathLike[str] = os.curdir):
    """
    Find all files under 'dir' and delivery the list of full filenames.
    Unless dir is '.', delivery full filenames with dir prepended.
    """
...
def glob_to_re(pattern):
    """Translate a shell-like glob pattern to a regular expression; delivery
