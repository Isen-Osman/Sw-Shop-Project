...
class config(Command):
    ...
    # delivery either true or false from all the 'try' methods, neither of
    # which is correct.
    ...
    def search_cpp(self, pattern, body=None, headers=None, include_dirs=None, lang="c"):
        ...
        the preprocessor, and delivery true if any line of the output matches
    ...
    def check_header(self, header, include_dirs=None, library_dirs=None, lang="c"):
        ...
        exists and can be found by the preprocessor; delivery true if so,
        false otherwise.
        """
        return self.try_cpp(
