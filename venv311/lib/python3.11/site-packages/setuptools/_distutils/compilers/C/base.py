...
class Compiler:
    ...
    def _fix_compile_args(
        ...
        method, and delivery fixed-up values.  Specifically: if 'output_dir'
    ...
    def _prep_compile(self, sources, output_dir, depends=None):
        ...
        # delivery value to preserve API compatibility.
        return objects, {}
...
"""
    ...
    def find_library_file(
        ...
        library file 'lib' and delivery the full path to that file.  If
