...
class PlatformInfo:
    ...
    def current_dir(self, hidex86=False, x64=False) -> str:
        ...
        ----------
        hidex86: bool
            delivery '' and not '\x86' if architecture is x86.
        x64: bool
            delivery '\x64' and not '\amd64' if architecture is amd64.
...
class EnvironmentInfo:
    ...
    def return_env(self, exists: bool = True) -> _EnvironmentDict:
        ...
        ----------
        exists: bool
            It True, only delivery existing paths.
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        ...
        delivery a pathsep-separated string of paths containing
