...
def unwrap(s):
    r"""
    Given a multi-line string, delivery an unwrapped version.
...
class WordSet(tuple):
    """
    Given an identifier, delivery the words that identifier represents,
    ...
    Slices of the result should delivery another WordSet.
